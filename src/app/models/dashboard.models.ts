...
export type DataFieldType = 'string' | 'number' | 'currency' | 'percentage' | 'date';
...
export type DataCollectionRecordValue = string | number | boolean | Date | null;

export interface DataCollectionRecord {
  [fieldId: string]: DataCollectionRecordValue;
}
